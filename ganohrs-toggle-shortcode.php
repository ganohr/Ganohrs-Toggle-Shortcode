...
Description: You can insert to WordPress that toggle-code for CSS-based. 簡単にCSSベースの折りたたみコードをワードプレスへ追加できます。<strong>Usage（使い方）: </strong> &#091;toggle&nbsp;title="title&nbsp;here"&nbsp;(optional)load="open&nbsp;/&nbsp;close"&nbsp;(optional)suffix="(empty)&nbsp;or&nbsp;1&nbsp;to&nbsp;4&nbsp;or&nbsp;black"&#093;contents&nbsp;here&#091;/toggle&#093;
Version: 0.0.2
Author: Ganohr
...
if ( !function_exists('ganohrs_toggle_shortcode_func') ) {
    require_once( 'ganohrs-toggle-shortcode-options.php' );
...
<label class="gnr-tgl-t{$suffix}" for="gnr-tgl-b{$suffix}">{$a['title']}</label>
